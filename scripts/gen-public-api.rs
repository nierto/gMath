...
const SURFACE: &[(&str, &str, &str, Option<&str>)] = &[
    ...
    ("src/fixed_point/imperative/predicates.rs", "g_math::fixed_point::imperative::predicates", "predicates", None),
...
const SECTIONS: &[(&str, &str)] = &[
    ...
    ("interval", "Certified intervals"),
    ("predicates", "Certified and exact predicates"),
